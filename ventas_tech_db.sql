...
-- ----------------------------------------------------------------------------
-- PASO 2: CREACIÓN DE TABLAS - DEFINICIÓN DEL ESQUEMA (DDL) Y CONSTRAINTS
-- ----------------------------------------------------------------------------
...
-- Tabla Dimensión: Productos (Relación 1:N con Categorías)
...
-- Tabla de Hechos: Ventas (Relación N:1 con Clientes y Productos)
CREATE TABLE ventas (
...
-- 2. Insertar Clientes (5 registros)
...
-- 3. Insertar Productos (6 registros)
...
-- 4. Insertar Ventas (10 registros)
